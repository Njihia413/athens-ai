                ...
                <div className="flex items-center w-100 justify-between">
                    ...
                    <ul className="flex items-center gap-x-3 lg:gap-x-5">
                        ...
                        <div className="inline-flex relative gap-2">
                            <div
                                className="font-dm-sans bg-[#3A4DF1] font-normal rounded-full text-white text-[16px] text-center px-4 py-3  cursor-pointer md:block ">
                                <Link to="/login">Login</Link>
                            </div>
                            <div
                                className="font-dm-sans bg-white border border-[#3A4DF1] font-normal rounded-full text-[#3A4DF1] text-[16px] text-center px-4 py-3  cursor-pointer md:block hidden">
