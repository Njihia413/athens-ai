            ...
            <Menu.Items ref={setPopperElement} style={styles.popper} {...attributes.popper} className="absolute end-0 top-10 w-80 bg-white dark:bg-slate-950 shadow-sm border border-slate-200 dark:border-slate-800 rounded-lg">
                <div className="py-3 px-5 flex items-center border-b border-slate-200 dark:border-slate-800">
                    <h5 className="text-md font-bold text-slate-600 dark:text-slate-100 inline-flex items-center">
                        ...
                        <span className="inline-flex ms-2 rounded-full text-xs font-bold text-[#3a4df1]">( 3 )</span>
                    </h5>
                </div>
                <div className="flex flex-col py-3">
                    <div className="px-5 py-2 flex items-start">
                        ...
                        <div className="ps-3 py-0.5">
                            <h6 className="text-sm text-slate-500 dark:text-slate-200"><strong className="text-slate-600 dark:text-slate-100">Arap Too</strong> Registered</h6>
                    ...
                    <div className="px-5 py-2 flex items-start">
                        ...
                        <div className="ps-3 py-0.5">
                            <h6 className="text-sm text-slate-500 dark:text-slate-200"><strong className="text-slate-600 dark:text-slate-100">Kevin Hector</strong> Registered</h6>
                    ...
                    <div className="px-5 py-2 flex items-start">
                        ...
                        <div className="ps-3 py-0.5">
                            <h6 className="text-sm text-slate-500 dark:text-slate-200"><strong className="text-slate-600 dark:text-slate-100">Amos</strong> Registered</h6>
