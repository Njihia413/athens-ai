                ...
                <div className="flex items-center w-100 justify-between">
                    ...
                    <ul className="flex items-center gap-x-3 lg:gap-x-5">
                        ...
                        <li className="inline-flex relative">
                            <Dropdown>
                                <Dropdown.Button
                                    className="inline-flex h-9 w-9 rounded-full overflow-hidden outline outline-2 outline-offset-2 outline-slate-300 dark:outline-slate-700">
                                    ...
                                    <Dropdown.Items className="absolute end-0 top-10 w-48 bg-white dark:bg-slate-950 shadow-sm border border-slate-200 dark:border-slate-800 rounded-lg">
                                        <div className="p-4 flex items-center">
                                            ...
                                            <div className="ms-4">
                                                ...
                                                <span
                                                    className="text-[10px] font-bold px-2 py-0.5 rounded-full text-green-500 bg-green-100 dark:bg-green-950">
                                                    Active
                                                </span>
                                            </div>
                                        </div>
