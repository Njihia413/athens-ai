        ...
        <div className="p-6">
            <div className="flex flex-wrap">
                <div className="md:hidden w-36 xs:w-28 sm:w-40 flex-shrink-0 mb-3">
                    <div
                        className="relative inline-flex flex-shrink-0  w-full rounded-lg overflow-hidden outline outline-2 outline-offset-2 outline-slate-300 dark:outline-slate-700">
                        <img src={ProfileImg} alt=""/>
                        <button
                            className="inline-flex items-center justify-center rounded-full h-8 w-8 lg:h-11 lg:w-11 text-slate-600 dark:text-slate-200 bg-white dark:bg-slate-950 absolute end-0 me-3 mt-3">
                    ...
                    <div className="flex flex-wrap -mx-3">
                        ...
                        <div className="w-1/2 md:w-1/3 px-3">
                            <div className="py-2">
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">1st October 2000</p>
                            </div>
                        </div>
                    </div>
                </div>
