...
const CustomerServiceTable = () => {
    // Filter users whose role is "Customer Service"
    const customerServiceUsers = users.filter(user => user.role === "Customer Service");

    return (
        <>
            <DataTable columns={columns} tableData={customerServiceUsers} />
        </>
    );
}
